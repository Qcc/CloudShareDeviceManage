<template>
<div>
  <div style="float:left;margin-bottom:10px;" v-if="propSearch">
  <el-row>
    <el-col :span="24">
  ...
  <el-col :span="24">
    <div style="padding-top:15px;margin-top:15px;border-top: 1px solid #cccccc;">
      <span>高级搜索 : </span>
  ...
  <div v-if="propADUQ" style="float:right">
    <el-row>
      <el-col>
        <el-button-group>
